...
export class Initialized__Params {
  ...
  get oTokenDecimals(): i32 {
    return this._event.parameters[2].value.toI32();
  }

  get oTokenName(): string {
    return this._event.parameters[3].value.toString();
  }

  get oTokenSymbol(): string {
...
export class OToken__getScaledUserBalanceAndSupplyResult {
  value0: BigInt;
  value1: BigInt;
...
export class OToken extends ethereum.SmartContract {
  ...
  OTOKEN_REVISION(): BigInt {
    let result = super.call(
      "OTOKEN_REVISION",
      "OTOKEN_REVISION():(uint256)",
      []
    );
  ...
  try_OTOKEN_REVISION(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "OTOKEN_REVISION",
      "OTOKEN_REVISION():(uint256)",
      []
  ...
  getScaledUserBalanceAndSupply(
    user: Address
  ): OToken__getScaledUserBalanceAndSupplyResult {
    let result = super.call(
      "getScaledUserBalanceAndSupply",
    ...
    return new OToken__getScaledUserBalanceAndSupplyResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getScaledUserBalanceAndSupply(
    user: Address
  ): ethereum.CallResult<OToken__getScaledUserBalanceAndSupplyResult> {
    let result = super.tryCall(
      "getScaledUserBalanceAndSupply",
      "getScaledUserBalanceAndSupply(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(user)]
    ...
    return ethereum.CallResult.fromValue(
      new OToken__getScaledUserBalanceAndSupplyResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
